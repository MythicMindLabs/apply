...
/* EchoPay-2 Global Styles - Updated for Design System */
:root {
...
@media (prefers-color-scheme: dark) {
  @keyframes voice-pulse {
    0% {
      box-shadow: 0 0 0 0 rgba(var(--color-teal-300-rgb), 0.7);
    }
    70% {
      box-shadow: 0 0 0 var(--space-10) rgba(var(--color-teal-300-rgb), 0);
    }
    100% {
      box-shadow: 0 0 0 0 rgba(var(--color-teal-300-rgb), 0);
    }
  }
}
